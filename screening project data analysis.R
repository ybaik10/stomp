...
screendata %>% filter(screened==1|screenedaway==1) %>% filter(xpertscreen_category %in% c(0,1)) %>% group_by(res_female) %>% count(xpertscreen_category)
...
(screendata %>% filter((screened==1|screenedaway==1) & res_female==1) %>% filter(xpertscreen_category %in% c(0,1)) %>% count(xpertscreen_category)) %>% prev(.)
(screendata %>% filter((screened==1|screenedaway==1) & res_female==0) %>% filter(xpertscreen_category %in% c(0,1)) %>% count(xpertscreen_category)) %>% prev(.)
